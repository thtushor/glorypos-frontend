  ...
  return (
    <div className={buttonContainerClassName}>
      ...
      <div className="relative">
        {/* ICON */}
        {Icon && (
          <div className="absolute z-50 border-r border-gray-200 inset-y-0 left-0 px-3 flex items-center pointer-events-none">
        ...
        {type !== "textarea" ? (
          <input
            ...
            required={required}
            className={`appearance-none no-spinner disabled:bg-gray-50 disabled:border-gray-200 disabled:text-gray-400 disabled:placeholder-gray-300 disabled:cursor-not-allowed bg-white placeholder:text-gray-400 text-gray-700 relative block w-full ${Icon ? "pl-12" : "pl-2"
              } pr-10 py-2 border border-gray-200 rounded-[4px] focus:outline-none focus:ring-brand-primary focus:border-brand-primary sm:text-sm ${className}`}
        ...
        {type === "password" && (
          <button
            ...
            className="absolute z-50 inset-y-0 right-0 px-3 flex items-center cursor-pointer text-gray-400 hover:text-gray-600"
          >
            {showPassword ? (
