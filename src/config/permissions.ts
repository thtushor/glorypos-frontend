...
export const PERMISSIONS = {
    ...
    PAYROLL: {
        ...
        DELETE_ADVANCE_SALARY: 'delete_advance_salary',
...
export const PERMISSION_GROUPS = [
    ...
    },
    {
        ...
        permissions: [
            ...
            { key: PERMISSIONS.INVENTORY.ADJUST_STOCK, label: 'Adjust Stock', description: 'Manually adjust product stock levels' },
    ...
    },
    {
        ...
        permissions: [
            ...
            { key: PERMISSIONS.PAYROLL.DELETE_ADVANCE_SALARY, label: 'Delete Advance Salary', description: 'Delete advance salary records' },
            { key: PERMISSIONS.PAYROLL.DELETE_PAYROLL, label: 'Delete Payroll', description: 'Delete payroll release records' },
...
export const PERMISSION_TEMPLATES = {
    ...
    MANAGER: [
        ...
        PERMISSIONS.PAYROLL.DELETE_ADVANCE_SALARY,
        PERMISSIONS.PAYROLL.DELETE_PAYROLL,
        PERMISSIONS.PAYROLL.VIEW_PROMOTION_HISTORY,
        PERMISSIONS.PAYROLL.MANAGE_PROMOTION,
